...
#' @description Family objects for normal distribution provide a convenient way to specify the details of the models used by functions such as \code{elliptical}.
#' @return An object of class "family" for normal distribution.
...
#' elliptical.fitN <- elliptical(y ~ x1+x2+x3, family = Normal()
#' ,data=luz)
